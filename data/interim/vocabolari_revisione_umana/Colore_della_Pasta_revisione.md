...
```yaml
forma_canonica: giallo paglierino
varianti: [giallo, dorato, ambrato]
frequenza_stimata: 253
note: "gonfalone nel DUBBIO 1"
```
...
```yaml
forma_canonica: carico
varianti: [carica, saturo, intenso, marcato, accentuato]
frequenza_stimata: 170
note: ""
```
...
```yaml
forma_canonica: chiaro
varianti: [chiara, scarico]
frequenza_stimata: 157
note: "chuaro/chiarimenti = typo (vedi sinonimi)"
```
...
```yaml
forma_canonica: omogeneo
varianti: [omogenea, uniforme]
frequenza_stimata: 155
note: ""
```
...
```yaml
forma_canonica: alone
varianti: []
frequenza_stimata: 151
note: "sganciato nel DUBBIO 2"
```
...
```yaml
forma_canonica: scuro
varianti: [scura, marrone, bruno, bruna, imbrunito]
frequenza_stimata: 111
note: ""
```
...
```yaml
forma_canonica: macchiato
varianti: [macchia, macchie, macchioline, chiazza, chiazze, puntini neri]
frequenza_stimata: 91
note: ""
```
...
```yaml
forma_canonica: esterno
varianti: [verso, sotto, vicino, bordo, bordi, lateralmente]
frequenza_stimata: 90
note: ""
```
...
```yaml
forma_canonica: lieve
varianti: [leggero, appena, lievemente, sfumatura, sfumato, sfumature]
...
```yaml
forma_canonica: disomogeneo
varianti: [non omogeneo, disomogeneità, eterogeneo, zona, zone, area, aree]
frequenza_stimata: 58
note: "bi color/3colori = espressioni informali per disomogeneità netta"
```
...
```yaml
forma_canonica: aranciato
varianti: [arancio, arancione, nocciola]
frequenza_stimata: 43
note: "arrangiato/tranciato = typo per aranciato (vedi sinonimi)"
```
...
```yaml
forma_canonica: a strisce
varianti: [fascia, fasce, striscia, strisce, striature]
...
```yaml
forma_canonica: bianco
varianti: [biancastro, candido, cipria]
...
```yaml
forma_canonica: sottocrosta
varianti: []
frequenza_stimata: 10
note: "termine INVARIABILE. sottoposta = typo (vedi sinonimi)"
```
...
varianti: [tirosina]
frequenza_stimata: 6
note: "termine INVARIABILE. hiroshima = typo autocorrect per tirosina"
```
...
tipo: sinonimo
note: "probabile dialettale per grosso alone al centro — DUBBIO 1"
```
...
a: "l'alone"
tipo: typo
note: "autocorrect nel commento del 2020"
```
