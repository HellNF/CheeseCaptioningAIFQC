...
varianti: [cotto, formaggio cotto, lattici cotti, latte bollito, formaggio fuso]
...
```yaml
forma_canonica: burro
varianti: [burro fuso, burro cotto, burroso, burro fresco, burro sciolto]
frequenza_stimata: 120
note: ""
```
...
varianti: [panna fresca, latte, lattico fresco, latte UHT]
...
```yaml
forma_canonica: crosta
varianti: [crosta di formaggio, crosta pulita]
frequenza_stimata: 80
note: ""
```
...
```yaml
forma_canonica: ossidato
varianti: [stantio, vecchio, passato, rancido, armadio della nonna]
frequenza_stimata: 50
note: ""
```
...
varianti: [erba, erbaceo, erbe amare, vegetale, paglia]
frequenza_stimata: 40
note: "pratomagno incluso nel DUBBIO 3"
```
...
```yaml
forma_canonica: verdure lesse
varianti: [minestrone, cipolla, sedano, cavolfiore]
frequenza_stimata: 30
note: "crauti inclusi nel DUBBIO — vedere posizionamento"
```
...
varianti: [frutta matura, ananas, mela, banana, pera, frutta tropicale]
frequenza_stimata: 30
note: ""
```
...
```yaml
forma_canonica: frutta secca
varianti: [nocciola, mandorla amara, castagne, noce]
...
varianti: [mou, cacao, cacao amaro, liquirizia, miele, biscotto]
...
a: stalla
tipo: sinonimo
note: "espressione colloquiale per forte difetto animale"
```
...
a: assente
tipo: sinonimo
note: "metafora per aroma del tutto svanito"
```
...
a: ossidato
tipo: sinonimo
note: "termine gergale per eccessiva maturazione/cattiva conservazione"
```
...
a: poco intenso
tipo: sinonimo
note: "gergale per bassa intensità retrolfattiva"
```
...
a: trentingrana
tipo: typo
note: "autocorrect di trentingrana"
```
