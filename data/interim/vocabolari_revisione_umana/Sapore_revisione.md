...
```yaml
forma_canonica: piccante
varianti: [piccantezza, piccantino, pizzica]
frequenza_stimata: 350
note: ""
```
...
```yaml
forma_canonica: salato
varianti: [sapido, sale, sapidità, salatino]
frequenza_stimata: 350
note: ""
```
...
```yaml
forma_canonica: amaro
varianti: [amarognolo, amarezza]
...
```yaml
forma_canonica: dolce
varianti: [dolcezza, dolciastro]
frequenza_stimata: 200
note: ""
```
...
```yaml
forma_canonica: acido
varianti: [acidità, acidulo, acre, acidino]
...
```yaml
forma_canonica: umami
varianti: [glutammato]
frequenza_stimata: 125
note: "umano e miami sono typo da autocorrect (vedi sinonimi)"
```
...
```yaml
forma_canonica: equilibrato
varianti: [equilibrio, armonico, bilanciato]
...
```yaml
forma_canonica: squilibrato
varianti: [disarmonico, sbilanciato, slegato, sgraziato]
...
```yaml
forma_canonica: pungente
varianti: [bruciante, brucia, irrita, pungenza, raschia in gola]
...
```yaml
forma_canonica: sciapo
varianti: [insipido, carente di sale, manca sale, poco salato]
...
```yaml
forma_canonica: pieno
varianti: [rotondo, complesso, completo]
frequenza_stimata: 15
note: ""
```
...
```yaml
forma_canonica: persistente
varianti: [persistenza, evanescente]
...
```yaml
forma_canonica: lattico
varianti: [grasso, unto, burroso, latte fresco, panna, burro]
frequenza_stimata: 13
note: "DUBBIO 6: unto/grasso potrebbero appartenere a struttura/texture"
```
...
```yaml
forma_canonica: sovramaturo
varianti: [vecchio, maturo, passato, sovramaturazione]
...
```yaml
forma_canonica: off-flavor
varianti: [metallico, gorgonzola, stalla, tossico, sapone]
frequenza_stimata: 11
note: "brodo nel DUBBIO 1; bresso nel DUBBIO 2; polvere nel DUBBIO 4; mentolato nel DUBBIO 7"
```
...
a: presente
tipo: dialetto
note: "espressione dialettale veneto-trentina"
```
...
a: sciapo
tipo: sinonimo
note: "colloquiale per carenza di sale"
```
...
a: formaggio giovane
tipo: sinonimo
note: "colloquiale per sapore privo di complessità"
```
...
a: umami
tipo: typo
note: "autocorrect classico di smartphone"
```
