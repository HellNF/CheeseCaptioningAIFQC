...
```yaml
forma_canonica: misura in mm
varianti: []
frequenza_stimata: 500
note: "km/kmm sono typo frequenti per mm (vedi sinonimi)"
```
...
```yaml
forma_canonica: sottile
varianti: [molto sottile, finissima, fine, bassa]
frequenza_stimata: 240
note: ""
```
...
```yaml
forma_canonica: spessa
varianti: [molto spessa, grossa, grossolana, alta, elevata]
frequenza_stimata: 172
note: "crostone nel DUBBIO 5"
```
...
```yaml
forma_canonica: limite netto
varianti: [netta, ben visibile, evidente, pronunciati, accentuati, stacco]
frequenza_stimata: 132
note: ""
```
...
```yaml
forma_canonica: regolare
varianti: [omogenea, omogeneo, bella, belli, buona, buoni, ottimi]
frequenza_stimata: 125
note: ""
```
...
```yaml
forma_canonica: limite sfumato
varianti: [sfumata, poco evidente, indefinita, difficile da misurare]
frequenza_stimata: 105
note: ""
```
...
```yaml
forma_canonica: irregolare
varianti: [disomogenea, difforme, poco regolare, orrendo, disastroso]
...
```yaml
forma_canonica: unghia evidente
varianti: [tanta unghia, unghia marcata, unghia spessa, unghia ampia]
...
```yaml
forma_canonica: colore chiaro
varianti: [chiaro, chiara, pulita]
...
```yaml
forma_canonica: difetto della crosta
varianti: [disidratato, secco, secchezza, muffa, ammuffita, marciume]
frequenza_stimata: 11
note: "carolata nel DUBBIO 3; rosure e tare nel DUBBIO 7"
```
...
a: per
tipo: abbreviazione
note: "es. x intensità = per intensità"
```
...
tipo: sinonimo
note: "DUBBIO 5 — potrebbe implicare anche durezza"
```
...
a: irregolare
tipo: sinonimo
note: "giudizi emotivi convertiti in descrittore oggettivo"
```
...
a: mm
tipo: typo
note: "frequente autocorrect del tablet"
```
...
a: sottocrosta
tipo: typo
note: "autocorrect errata del tablet"
```
...
a: aranciato
tipo: typo
note: "probabile autocorrect per colore sottocrosta"
```
...
a: aranciato
tipo: typo
note: "probabile autocorrect — stessa radice fonetica"
```
...
a: crosta
tipo: typo
note: "bizzarra autocorrect — Christine sugli scalzi = croste sugli scalzi"
```
...
note: "punteggi 2018 ottimali 9.0-9.5 per ~5mm"
```
...
note: "punteggi 2018 buoni 7.0-8.3 per 8-10mm"
```
...
range_max_mm: 17
forma_canonica: spessa
note: "punteggi 2018 penalizzati 4.4-6.6 per 12-15mm"
```
...
range_min_mm: 18
range_max_mm: 999
forma_canonica: molto spessa
note: "punteggi 2018 severi 5.6-6.0 per 20-22mm"
```
