...
varianti: []
frequenza_stimata: 200
note: "termine INVARIABILE. Anna è typo (vedi sinonimi)"
```
...
```yaml
forma_canonica: frattura
varianti: []
frequenza_stimata: 200
note: "termine INVARIABILE. da bombardamento = iperbole; MaceRO = typo"
```
...
```yaml
forma_canonica: microocchiatura
varianti: [microcchiatura]
frequenza_stimata: 150
note: "termine INVARIABILE. mic/microocch. = abbreviazioni; Microsoft = autocorrect"
```
...
```yaml
forma_canonica: stirata
varianti: [stiratura, tendente allo stirato]
frequenza_stimata: 100
note: "termine INVARIABILE. st = abbreviazione; strirata = typo"
```
...
```yaml
forma_canonica: omogenea
varianti: [regolare, non regolare]
frequenza_stimata: 180
note: "il negativo è disomogenea/irregolare"
```
...
```yaml
forma_canonica: occhiatura
varianti: [occhi, occhio]
frequenza_stimata: 95
note: "termine INVARIABILE. bocciatura/dittatura/carolatura = typo. Occhio di Sauron = iperbole"
```
...
```yaml
forma_canonica: fessurazione
varianti: [fessura, fessure, spacco, spacchi, spaccatura, crepa, crepe]
frequenza_stimata: 110
note: ""
```
...
```yaml
forma_canonica: granulosa
varianti: [granulosità, grano di riso]
frequenza_stimata: 50
note: "grandiosa/grandiosità = typo per granulosa (vedi sinonimi)"
```
...
```yaml
forma_canonica: spugnosa
varianti: [spugna, spugnatura, spugnosità]
frequenza_stimata: 45
note: "spagnola/spinosa/impugnatura/pugnosa = typo fonetici (vedi sinonimi)"
```
...
```yaml
forma_canonica: strappo
varianti: [strappi, strappetto]
...
```yaml
forma_canonica: sfoglia
varianti: [sfogliata, fogliata, scaglie, scagliosa]
frequenza_stimata: 40
note: ""
```
...
note: "termine INVARIABILE. perle = gergale per aggregati anomali di tirosina"
```
...
```yaml
forma_canonica: ruvida
varianti: [sabbiosa, sabbia]
frequenza_stimata: 17
note: "tipo carta vetro = similitudine (vedi sinonimi)"
```
...
```yaml
forma_canonica: disidratata
varianti: [asciutta, secca]
frequenza_stimata: 17
note: "demineralizzato/demoralizzato = autocorrect per disidratato"
```
...
```yaml
forma_canonica: gessata
varianti: [gessato]
frequenza_stimata: 11
note: "cessata = typo per gessata"
```
...
varianti: [compattata, plastica]
frequenza_stimata: 10
...
```yaml
forma_canonica: slegata
varianti: [slegato, disunita, scollata]
frequenza_stimata: 6
note: ""
```
...
```yaml
forma_canonica: pastosa
varianti: [impasta, pastoso, gommoso]
frequenza_stimata: 6
note: ""
```
...
```yaml
forma_canonica: caverna
varianti: [cavernosa, vasca, cratere]
frequenza_stimata: 5
note: ""
```
...
tipo: sinonimo
note: "iperbole per frattura estremamente sconnessa"
```
...
a: pasta pastosa
tipo: sinonimo
note: "gergale per pasta eccessivamente umida o untuosa"
```
...
a: microocchiatura
tipo: typo
note: "errore correttore ortografico"
```
...
a: grana
tipo: typo
note: "autocorrect per grana (es. Struttura Anna regolare)"
```
