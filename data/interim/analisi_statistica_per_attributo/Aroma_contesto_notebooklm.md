# Contesto Analisi Sensoriale Grana Trentino — Aroma
...
## Questo attributo: Aroma
L'Aroma è la percezione retrolfattiva che si sviluppa durante la masticazione, quando i composti volatili salgono alla cavità nasale attraverso il rinofaringe. È tipicamente più intensa del Profumo e include note lattiche, burro fuso, panna, frutta (ananas, mela), vegetale, animale (brodo, prosciutto), insilato, ossidato/rancido. Un aroma 'nella norma' è quello caratteristico del Grana Trentino stagionato.
...
- **File 2018**: la 4a colonna (`Aroma`) è il **punteggio numerico individuale**
...
## Statistiche dei commenti per Aroma

| Anno | Totale righe | Commenti validi | % vuoti | Lungh. media (char) |
|------|-------------|-----------------|---------|---------------------|
| 2018 | 1561 | 876 | 43.9% | 28.9 |
| 2019 | 62 | 58 | 6.5% | 24.2 |
| 2020 | 117 | 116 | 0.9% | 24.5 |
| 2021 | 55 | 47 | 14.5% | 20.3 |

**Termini più frequenti (top 20):** "cotto", "burro", "formaggio", "crosta", "latte", "panna", "brodo", "grana", "note", "lattico", "fuso", "leggero", "nota", "tostato", "animale", "vegetale", "aroma", "fermentato", "cotti", "lattici"
...
Costruire un **dizionario di normalizzazione** per l'attributo Aroma:
